...
Public Class ReportePagoExtra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AcademiaComputacion.ReportePagoExtra.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idPaymentExtra() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportePagoExtra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePagoExtra = New ReportePagoExtra()
        rpt.Site = Me.Site
        Return rpt
    End Function
